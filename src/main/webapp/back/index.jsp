            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/user/information.jsp');"  style="margin-top: 5px" class="glyphicon glyphicon-user"> 个人信息</a></li>
                        <li role="separator" class="divider"></li>
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                            ...
                            <div class="list-group">
                                ...
                                <a href="javascript:$('#content').load('${pageContext.request.contextPath}/student/findAll');" id="StuBtn" class="list-group-item">学生列表</a>
                            </div>
                            <div>
                                <a href="javascript:$('#content').load('${pageContext.request.contextPath}/back/scourse/grades.jsp');" id="ScourseBtn" class="list-group-item">学生成绩</a>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                            ...
                            <div class="list-group">
                                <!--动态更新内容 load 将远程url对应的页面源码包含到指定源码选择器中-->
                                <a href="javascript:$('#content').load('${pageContext.request.contextPath}/course/findAll');" class="list-group-item">课程列表</a>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                        <div class="list-group">
                            <!--动态更新内容 load 将远程url对应的页面源码包含到指定源码选择器中-->
                            <a href="javascript:$('#content').load('${pageContext.request.contextPath}/user/findAll?pageNum=1');" id="UserBtn" class="list-group-item">职工用户列表</a>
                        </div>
                    </div>
                </div>
            </div>
