  ...
  <div class="row">
    ...
    <div class="col-sm-10">
      ...
      <div id="bg" class="jumbotron jumbotron-fluid">
        <div class="container">
          <h2>Hello！${sessionScope.user.realname}同学！</h2>
        </div>
      </div>
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-7">
            <ul class="list-group">
              <li class="list-group-item">学号：2132Z12340</li>
              <li class="list-group-item">姓名：杨凯胜</li>
              <li class="list-group-item">用户名：1977016033</li>
