    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="page-header" style="margin-top: -20px;margin-bottom: 10px">
                ...
                <h3>您的班级：2132Z123 ———— 您的学号尾号：40 ———— 您的姓名：杨凯胜</h3>
            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <table class="table" id="tableContent">
                                ...
                                <tr>
                                    ...
                                    <td>8</td>
                                    <td>
                                        <a href="javascript:;" onclick="DelCourseRow('${courses.cid}')"
                                ...
                                <c:forEach items="${requestScope.grades}" var="grades">
                                    <tr>
                                        <th scope="row">${grades.cid}</th>
                                        <td>${grades.cname}</td>
                                        <td>${grades.choose?'必修课':'选修课'}</td>
                                    ...
                                    <form id="courseSaveForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="dd" name="choose">
                                                <option value="大型软硬件实验周">大型软硬件实验周</option>
